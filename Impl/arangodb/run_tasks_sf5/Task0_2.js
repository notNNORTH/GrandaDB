...
res1 = db._query('FOR person_id IN 0..49744 FOR tag_id IN 0..1499 INSERT {_key: CONCAT(TO_STRING(person_id), ",", TO_STRING(tag_id)), person_id: person_id, tag_id: tag_id, val: 0} INTO TEMP_A').getExtra();
...
res3 = db._query('FOR person_id IN 0..49744 INSERT {_key: TO_STRING(person_id), person_id: person_id, val: 0} INTO TEMP_C').getExtra();
...
res5 = db._query('FOR i IN 0..1499 INSERT {i: i, val: 1} INTO LR_w').getExtra();
