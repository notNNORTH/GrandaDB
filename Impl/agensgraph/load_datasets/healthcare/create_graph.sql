...
SERVER test
OPTIONS (FORMAT 'csv', HEADER 'true', FILENAME '../../../../Datasets/healthcare/property_graph/Disease_network_nodes.csv', delimiter',');
...
SERVER test
OPTIONS (FORMAT 'csv', HEADER 'true', FILENAME '../../../../Datasets/healthcare/property_graph/Disease_network_edges.csv', delimiter',');
